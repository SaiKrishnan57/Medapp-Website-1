            ...
            <Container className="p-4">
                ...
                <Row align="center">
                    <Col sm={2}>
                        <a href='https://www.aninews.in/news/business/medapp-a-game-changer-of-the-healthcare-ecosystem-in-india20190417193514/'>
                            <Image src='https://assets-news-bcdn-ll.dailyhunt.in/cmd/resize/400x400_60/fetchdata13/images/70/cb/91/70cb919a9921e6ffe72f372eb5dbde14.jpg' style={{height:'100px'}}/>
                        </a>
                    </Col>
                    ...
                    <Col sm={2}><a href='https://www.msn.com/en-in/?ref-st=%2fen-in%2fnews%2fother%2fmedapp-a-game-changer-of-the-healthcare-ecosystem-in-india%2far-BBW2cZ4'><Image src='https://upload.wikimedia.org/wikipedia/commons/a/a0/Msn_logo.jpg' style={{height:'100px'}}/></a></Col>
                ...
                <Container className="p-4">
                    <Row align="center">
                        ...
                        <Col sm={2} ><a href="https://www.marketscreener.com/MEDAPP-SA-38028268/news/Medapp-a-game-changer-of-the-healthcare-ecosystem-in-India-28440866/"><Image  className="mt-2" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRLrqqF58gqmbzLUtbJkARMr08bVdMP1O-umoMA_A0xtOjuB2rH" style={{height:'100px',width:'200px'}}/></a></Col> 
               ...
               <Container className="p-4">
                    <Row align="center">
                        ...
                        <Col sm={2}><a href="http://www.punjabtribune.com/news/89379-medapp-a-game-changer-of-the-healthcare-ecosystem-in-india.aspx"><Image className="ml-4 mt-2" src="http://www.punjabtribune.com/images/thumb/tnl490.jpg" style={{height:'100px',width:'200px',backgroundColor:'black'}}/></a></Col>
                        <Col sm={2}><a href="https://menafn.com/1098403365/MedappA-Game-Changer-of-the-Healthcare-Ecosystem-in-India"><Image className="ml-5 mt-2" src="https://menafn.com/includes/img/logo.jpg" style={{height:'100px',width:'150px'}}/></a></Col>
                ...
                <Container className="p-4">
                    <Row align="center">
                        ...
                        <Col sm={2}><a href="http://netindian.in/corporatewire?c_article_id=11699&c_author_id=9463"><Image className="ml-3 mt-2" src="http://netindian.in/sites/default/files/indiainfostyle_logo.png" style={{height:'60px',width:'150px',backgroundColor:'black'}}/></a></Col>
